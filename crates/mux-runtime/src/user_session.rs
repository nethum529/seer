use crate::PaneHost;
use mux_core::layout::{PaneRect, rects};
use mux_core::proto::{ClientMsg, ServerMsg};
use mux_core::{PaneSize, Tab, Tree, TreeError};
...
impl UserSession {
    ...
    fn split_pane(&mut self, direction: mux_core::SplitDirection) -> io::Result<Vec<ServerMsg>> {
